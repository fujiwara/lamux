...
require (
	...
	github.com/mashiike/go-otlp-helper v0.2.6 // indirect
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sts v1.31.3 // indirect; indirect1	github.com/jmespath/go-jmespath v0.4.0 // indirect
