...
require (
	...
	github.com/mashiike/go-otlp-helper v0.4.2 // indirect
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sts v1.41.10 // indirect; indirect1	github.com/jmespath/go-jmespath v0.4.0 // indirect
